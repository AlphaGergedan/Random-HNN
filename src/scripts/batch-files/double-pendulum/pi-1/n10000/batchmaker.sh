...
while [ $train_set_size -ge 5000 ]
do
	filename="solvehamil_"$train_set_size"_double_pendulum_pi_1_n10000.sh"

	echo $filename "created"

	echo "#!/bin/bash
#SBATCH -J solvehamil_"$train_set_size"_double_pendulum_pi_1_n10000.sh
#SBATCH -o "$SCRATCH"/solve-hamil/double-pendulum/pi-1/r10/n10000/"$train_set_size"_double_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
