#!/bin/bash
#SBATCH -J solvehamil_20000_double_pendulum_pi_1_n10000.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/double-pendulum/pi-1/r10/n10000/20000_double_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
