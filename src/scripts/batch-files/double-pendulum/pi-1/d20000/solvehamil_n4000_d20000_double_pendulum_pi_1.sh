#!/bin/bash
#SBATCH -J solvehamil_n4000_d20000_double_pendulum_pi_1.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/double-pendulum/pi-1/r10/d20000/4000_double_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
