#!/bin/bash
#SBATCH -J solvehamil_n8500_d20000_henon_heiles_alpha_0.9_1_1.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/henon-heiles/r10/alpha-0.9/1-1/d20000/8500_henon_heiles_alpha_0.9.txt
#SBATCH -D ./
#SBATCH --get-user-env
