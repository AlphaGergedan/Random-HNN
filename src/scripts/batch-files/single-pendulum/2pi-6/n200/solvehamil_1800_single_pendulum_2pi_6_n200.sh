#!/bin/bash
#SBATCH -J solvehamil_1800_single_pendulum_2pi_6_n200.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/2pi-6/n200/1800_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
