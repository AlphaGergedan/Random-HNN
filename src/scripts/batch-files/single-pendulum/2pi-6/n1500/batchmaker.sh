...
do
	filename="solvehamil_"$train_set_size"_single_pendulum_2pi_6_n1500.sh"

	echo $filename "created"

	echo "#!/bin/bash
#SBATCH -J solvehamil_"$train_set_size"_single_pendulum_2pi_6_n1500.sh
#SBATCH -o "$SCRATCH"/solve-hamil/single-pendulum/2pi-6/n1500/"$train_set_size"_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
