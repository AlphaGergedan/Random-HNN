#!/bin/bash
#SBATCH -J solvehamil_7500_single_pendulum_2pi_6_n1500.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/2pi-6/n1500/7500_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
