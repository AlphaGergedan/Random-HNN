#!/bin/bash
#SBATCH -J solvehamil_n100_d10000_single_pendulum_2pi_6.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/2pi-6/d10000/100_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
