#!/bin/bash
#SBATCH -J solvehamil_n1400_d10000_single_pendulum_2pi_1.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/2pi-1/d10000/1400_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
