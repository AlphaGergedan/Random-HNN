#!/bin/bash
#SBATCH -J solvehamil_2500_single_pendulum_2pi_1_n1500.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/2pi-1/n1500/2500_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
