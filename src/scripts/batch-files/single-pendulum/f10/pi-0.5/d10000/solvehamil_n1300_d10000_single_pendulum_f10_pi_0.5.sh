#!/bin/bash
#SBATCH -J solvehamil_n1300_d10000_single_pendulum_f10_pi_1.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/f10/pi-0.5/d10000/1300_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
