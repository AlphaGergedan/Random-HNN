...
do
	...
	filename="solvehamil_"$num_points"_single_pendulum_f20_pi_0.5.sh"

	echo $filename "created"

	echo "#!/bin/bash
#SBATCH -J solvehamil_"$num_points"_single_pendulum_f20_pi_0.5.sh
#SBATCH -o "$SCRATCH"/solve-hamil/single-pendulum/f20/pi-0.5/"$num_points"_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
