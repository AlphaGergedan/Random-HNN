#!/bin/bash
#SBATCH -J solvehamil_2940_single_pendulum_f20_pi_0.5.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/f20/pi-0.5/2940_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
