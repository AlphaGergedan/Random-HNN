#!/bin/bash
#SBATCH -J solvehamil_960_single_pendulum_f15_pi_0.5.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/single-pendulum/f15/pi-0.5/960_single_pendulum.txt
#SBATCH -D ./
#SBATCH --get-user-env
