#!/bin/bash
#SBATCH -J solvehamil_1500_lotka_volterra_large_0_8.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/lotka-volterra/large/0-8/n1500/1500_lotka_volterra_large.txt
#SBATCH -D ./
#SBATCH --get-user-env
