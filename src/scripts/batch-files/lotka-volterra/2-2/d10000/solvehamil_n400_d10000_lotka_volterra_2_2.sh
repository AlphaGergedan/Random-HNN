#!/bin/bash
#SBATCH -J solvehamil_n400_d10000_lotka_volterra_2_2.sh
#SBATCH -o /gpfs/scratch/pr63so/ge49rev3/solve-hamil/lotka-volterra/2-2/d10000/400_lotka_volterra.txt
#SBATCH -D ./
#SBATCH --get-user-env
