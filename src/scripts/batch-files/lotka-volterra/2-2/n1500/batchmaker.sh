...
do
	filename="solvehamil_"$train_set_size"_lotka_volterra_2_2.sh"

	echo $filename "created"

	echo "#!/bin/bash
#SBATCH -J solvehamil_"$train_set_size"_lotka_volterra_2_2.sh
#SBATCH -o "$SCRATCH"/solve-hamil/lotka-volterra/2-2/n1500/"$train_set_size"_lotka_volterra.txt
#SBATCH -D ./
#SBATCH --get-user-env
